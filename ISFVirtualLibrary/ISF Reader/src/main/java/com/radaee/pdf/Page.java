...
public class Page
{
	...
	public class Annotation
	{
		 ...
		 */
		public int GetAnnotListItemCount()
		{
		 ...
		 */
		public String GetAnnotListItem( int item )
		{
		 ...
		 * @return true or false
		 */
		public boolean SetAnnotListSels( int[] items )
		{
		...
		/**
		 * get fill color of square/circle/ink/line/underline/Squiggly/strikeout/ploygon/polyline/free text annotation.<br/>
		 * this can be invoked after ObjsStart or Render or RenderToBmp.<br/>
		 * this method valid in professional or premium version
		 * @return color value formatted as 0xAARRGGBB, if 0 returned, means false.
		 */
