...
public class Global {
	...
	public static void Init(Activity act)
	{
        ...
        try {
            ...
            String licenseCompany = properties.getProperty("radaee_license_company");
            String licenseMail = properties.getProperty("radaee_license_mail");
            String licenseSerial = properties.getProperty("radaee_license_serial");
            boolean succeeded = activeStandard(act, licenseCompany,
                    licenseMail, licenseSerial);
        }
